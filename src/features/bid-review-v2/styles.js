...
(function () {
  ...
  var css = [
    ...
    '}',
    '.scw-bid-review-v2__photo-viewer-actions {',
    '  position: absolute; top: 8px; left: 8px; z-index: 2;',
    '  display: inline-flex; gap: 6px;',
    '}',
    '.scw-bid-review-v2__photo-viewer-open,',
    '.scw-bid-review-v2__photo-viewer-edit {',
    ...
    '  display: inline-flex; align-items: center; gap: 4px;',
    '}',
    '.scw-bid-review-v2__photo-viewer-open:hover { background: rgba(15,23,42,0.95); color: #fff; }',
    '.scw-bid-review-v2__photo-viewer-edit {',
    '  background: rgba(109,40,217,0.92); border-color: rgba(255,255,255,.3);',
    '}',
    '.scw-bid-review-v2__photo-viewer-edit:hover { background: rgba(91,33,182,1); color: #fff; }',
