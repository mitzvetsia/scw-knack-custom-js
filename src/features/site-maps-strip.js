...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '.scw-maps__doc {',
      '  display: flex; align-items: center; gap: 10px; width: 300px; max-width: 100%; box-sizing: border-box;',
      '  border: 1px solid #e2e8f0; border-radius: 10px; padding: 10px 12px; background: #fff; align-self: flex-start;',
      '}',
      '.scw-maps__doc .scw-maps__btn { padding: 4px 7px; }',
      ...
      '.scw-maps__tiles { display: flex; gap: 12px; flex-wrap: wrap; align-items: flex-start; }',
