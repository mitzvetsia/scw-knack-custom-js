...
(function () {
  ...
  function inject() {
    ...
    var css = [
      ...
      '  transition: all .15s; line-height: 1 !important; padding: 0 !important;',
      '  box-shadow: none !important; min-width: 0 !important;',
      '}',
      '.' + P + '-action-btn:hover {',
      '  background: #cbd5e1 !important; color: #334155 !important;',
      '}',
      '.' + P + '-action-btn--revise {',
      '  background: #3b82f6 !important; color: #fff !important;',
      '}',
      '.' + P + '-action-btn--revise:hover { background: #2563eb !important; }',
      '.' + P + '-action-btn--add {',
      '  background: #16a34a !important; color: #fff !important;',
      '}',
      '.' + P + '-action-btn--add:hover { background: #15803d !important; }',
      '.' + P + '-action-btn--remove {',
      '  background: #dc2626 !important; color: #fff !important;',
      '}',
      '.' + P + '-action-btn--remove:hover { background: #b91c1c !important; }',
      '.' + P + '-action-btn--note {',
      '  background: #60a5fa !important; color: #fff !important;',
      '}',
      '.' + P + '-action-btn--note:hover { background: #3b82f6 !important; }',
      ...
      '}',
      /* Bulk-removal item list — every row named before N items are marked
         for removal at once; scrolls rather than pushing the footer away. */
      '.' + P + '-modal__bulklist {',
      '  max-height: 190px; overflow-y: auto; margin: 0 0 12px;',
      '  border: 1px solid #e2e8f0; border-radius: 6px; background: #fff;',
      '}',
      '.' + P + '-modal__bulkitem {',
      '  display: flex; align-items: center; gap: 8px;',
      '  padding: 5px 10px; font-size: 12.5px; color: #1e293b;',
      '  border-top: 1px solid #f1f5f9;',
      '}',
      '.' + P + '-modal__bulkitem:first-child { border-top: 0; }',
      '.' + P + '-modal__bulkflag {',
      '  margin-left: auto; flex: 0 0 auto; padding: 1px 7px;',
      '  border-radius: 999px; background: #fef3c7; border: 1px solid #fde68a;',
      '  color: #92400e; font: 600 10px/1.5 system-ui, sans-serif;',
      '  white-space: nowrap;',
      '}',
      '.' + P + '-modal__textarea {',
