...
(function () {
  ...
  function injectCss() {
    ...
    s.textContent = [
      ...
      // plain text (no box, no border) so nothing reads as editable. The
      // stage strip's buttons live in this form too — they are <button>s,
      // not inputs, so they stay live (Recall from Sub).
