...
(function () {
  ...
  var css = [
    ...
    '  align-items: stretch !important;',
    '  gap: 6px !important;',
    '  padding: 6px 14px 8px 34px !important;',
    '  background: #f8fafc !important;',
    '  border-top: 1px solid #eef2f7 !important;',
    '}',
    '.scw-ws-v2-photos-empty {',
    '  flex: 0 0 auto !important;',
    '  align-self: center !important;',
    '  color: #94a3b8 !important;',
    ...
    '  text-decoration: none !important;',
    '  color: inherit !important;',
    '  transition: border-color 100ms ease, transform 100ms ease !important;',
    '}',
    '.scw-ws-v2-photo-card:hover {',
    '  border-color: #93c5fd !important;',
    '  transform: translateY(-1px) !important;',
    '}',
    '.scw-ws-v2-photo-card--required { border-color: #fcd34d !important; }',
    '.scw-ws-v2-photo-card--missing  { border-color: #f87171 !important; background: #fef2f2 !important; }',
    '.scw-ws-v2-photo-img {',
    '  display: block !important;',
    '  width: 100% !important;',
    ...
    '  font: 600 9px/1.15 system-ui, sans-serif !important;',
    '  color: #475569 !important;',
    '  text-align: center !important;',
    '  white-space: nowrap !important;',
    '  overflow: hidden !important;',
