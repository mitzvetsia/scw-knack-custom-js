...
(function () {
  ...
  var css = [
    ...
    '}',
    '.scw-ws-v2-photo-add-icon {',
    '  font-size: 28px !important; line-height: 1 !important; font-weight: 300 !important;',
    '}'
  ].join('\n');
