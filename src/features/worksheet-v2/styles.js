...
(function () {
  ...
  var css = [
    ...
    '  border-bottom: 1px solid #e2e8f0 !important;',
    '}',
    '.scw-ws-v2-summary-stat {',
    '  display: inline-flex !important;',
    '  align-items: baseline !important;',
    '  gap: 6px !important;',
    '}',
    '.scw-ws-v2-summary-stat-value {',
    '  font: 700 14px/1 system-ui, -apple-system, sans-serif !important;',
    '  color: #0f172a !important;',
    '  font-variant-numeric: tabular-nums !important;',
    '}',
    '.scw-ws-v2-summary-stat-label {',
    '  font: 500 11px/1 system-ui, sans-serif !important;',
    '  color: #64748b !important;',
    '  text-transform: uppercase !important;',
    '  letter-spacing: 0.04em !important;',
    '}',
    '.scw-ws-v2-summary-chips {',
    '  display: inline-flex !important;',
    '  flex-wrap: wrap !important;',
    '  gap: 6px !important;',
    '  margin-left: auto !important;',
    '}',
    '.scw-ws-v2-summary-chip {',
    '  display: inline-flex !important;',
    '  align-items: center !important;',
    '  padding: 2px 8px !important;',
    ...
    '}',
    '.scw-ws-v2-summary-chip--cam        { background: #fef3c7 !important; color: #92400e !important; }',
    '.scw-ws-v2-summary-chip--default    { background: #dbeafe !important; color: #1e40af !important; }',
    '.scw-ws-v2-summary-chip--services   { background: #ede9fe !important; color: #5b21b6 !important; }',
    '.scw-ws-v2-summary-chip--assumptions{ background: #f3f4f6 !important; color: #374151 !important; }'
  ].join('\n');
