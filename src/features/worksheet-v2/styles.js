...
(function () {
  ...
  var css = [
    ...
    '}',
    /* Accessory qty stepper — small ± buttons + current qty, slotted
       between the chip label and the delete X. Only present when the
       bracket\'s field_2230 allows multi-qty. */
    ...
    '  display: inline-flex; align-items: center; justify-content: center;',
    '}',
    '.scw-ws-v2-mh-step:hover { background: #f1f5f9 !important; color: #07467c !important; }',
    '.scw-ws-v2-mh-step:disabled { opacity: 0.35 !important; cursor: not-allowed !important; }',
    '.scw-ws-v2-mh-qty {',
