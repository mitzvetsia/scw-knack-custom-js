...
(function () {
  ...
  var css = [
    ...
    /* Per-card select checkbox — sits in a dedicated gutter on the
       card\'s left edge, vertically centered with the row content. */
    '.scw-ws-v2-card { position: relative !important; padding-left: 28px !important; }',
    '.scw-ws-v2-card > .scw-ws-v2-select {',
    ...
    '  z-index: 2 !important;',
    '}',
    '.scw-ws-v2-card:hover > .scw-ws-v2-select,',
    '.scw-ws-v2-card > .scw-ws-v2-select:checked,',
    '.scw-ws-v2-card--selected > .scw-ws-v2-select {',
    '  opacity: 1 !important;',
    '}',
