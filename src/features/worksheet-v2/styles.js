...
(function () {
  ...
  var css = [
    ...
    '}',
    '.scw-ws-v2-bulk-clear {',
    '  background: transparent !important;',
    '  color: #cbd5e1 !important;',
    '}',
    '.scw-ws-v2-bulk-clear:hover { color: #fff !important; }',
    ...
    /* Remove-accessories — secondary destructive (amber), less alarming */
    /* than the full red Delete since it only touches child accessories.  */
    ...
    '}',
    '.scw-ws-v2-bulk-remove-acc:hover {',
    '  background: #b45309 !important;',
    '  border-color: #b45309 !important;',
    '  color: #fff !important;',
    '  box-shadow: 0 0 0 3px rgba(217, 119, 6, 0.22) !important;',
    '}',
    '.scw-ws-v2-bulk-remove-acc:disabled {',
    '  background: transparent !important;',
    '  color: rgba(253, 228, 191, 0.4) !important;',
    '  border-color: rgba(217, 119, 6, 0.2) !important;',
    '  box-shadow: none !important;',
    '  cursor: not-allowed !important;',
    '}',
    '.scw-ws-v2-bulk-remove-acc svg { flex: 0 0 auto !important; }',
    /* Add accessories — positive/additive action (green), distinct from   */
    /* the blue Edit and the red/amber destructive buttons.                 */
    '.scw-ws-v2-bulk-add-acc {',
    '  background: rgba(22, 163, 74, 0.9) !important;',
    '}',
    '.scw-ws-v2-bulk-add-acc:hover:not(:disabled) {',
