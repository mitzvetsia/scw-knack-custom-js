...
(function () {
  ...
  var css = [
    ...
    /* ── GRAND SUMMARY (whole-grid) ─────────────────────────── */
    '.scw-ws-v2-grand-summary {',
    '  padding: 14px 16px !important;',
    '  background: #fff !important;',
    '  border-bottom: 2px solid #cbd5e1 !important;',
    '}',
    '.scw-ws-v2-grand-summary-head {',
    '  display: flex !important;',
    ...
    '}',
    '.scw-ws-v2-grand-summary-title {',
    '  font: 700 13px/1.2 system-ui, sans-serif !important;',
    '  color: #0f172a !important;',
    '  text-transform: uppercase !important;',
    '  letter-spacing: 0.04em !important;',
    '}',
    '.scw-ws-v2-grand-summary-meta {',
    '  font: 500 11px/1.2 system-ui, sans-serif !important;',
    '  color: #64748b !important;',
    '}',

    /* ── SUMMARY PANEL (v1-parity table) ─────────────────────── */
    '.scw-ws-v2-summary {',
    '  padding: 10px 14px !important;',
    '  background: #fff !important;',
    '  border-bottom: 1px solid #e2e8f0 !important;',
    '}',
    '.scw-ws-v2-summary--empty { padding: 8px 14px !important; }',
