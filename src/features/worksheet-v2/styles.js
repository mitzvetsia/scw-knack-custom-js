...
(function () {
  ...
  var css = [
    ...
    '}',
    '.scw-ws-v2-bulk-modal-actions-spacer { flex: 1 1 auto !important; }',
    /* Destructive button — left side of the footer per CLAUDE.md\'s
       button-order rule (destructive first / primary last). */
    '.scw-ws-v2-bulk-modal-delete {',
    '  background: #fff !important;',
    '  color: #b91c1c !important;',
    ...
    '  cursor: pointer !important;',
    '}',
    '.scw-ws-v2-bulk-modal-delete:hover {',
    '  background: #fee2e2 !important;',
    '  border-color: #fca5a5 !important;',
    '  color: #991b1b !important;',
    '}',
    '.scw-ws-v2-bulk-modal-delete:disabled {',
    '  background: #fff !important;',
    '  color: #cbd5e1 !important;',
