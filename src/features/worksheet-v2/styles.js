...
(function () {
  ...
  var css = [
    ...
    /* Per-card select checkbox — absolutely positioned over the row */
    '.scw-ws-v2-card { position: relative !important; }',
    ...
    /* L1 head + select wrapper — places a checkbox before the toggle */
    '.scw-ws-v2-l1-head-wrap {',
    '  display: flex !important;',
    '  align-items: stretch !important;',
    '  gap: 0 !important;',
    '}',
    '.scw-ws-v2-l1-head-wrap > .scw-ws-v2-l1-head { flex: 1 1 auto !important; }',
    '.scw-ws-v2-l1-select {',
