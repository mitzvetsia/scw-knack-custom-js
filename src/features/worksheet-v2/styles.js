...
(function () {
  ...
  var css = [
    ...
    '}',
    /* Product cell becomes a vertical stack: product button on top,
       warning chips beneath. Override the base product-cell\'s nowrap /
       overflow:hidden so the chips line isn\'t clipped. */
    '.scw-ws-v2-cell.scw-ws-v2-cell--prodwrap {',
    ...
    '  color: var(--scw-text-default, #1f2937) !important;',
    '}',
    /* Separate warning chips beneath the product name. */
    '.scw-ws-v2-prod-warnings {',
    '  display: flex !important;',
    ...
    '  font: 700 9.5px/1.4 system-ui, -apple-system, sans-serif !important;',
    '  cursor: pointer !important;',
    '  white-space: nowrap !important;',
    '}',
    ...
    '  width: 11px !important; height: 11px !important; flex: 0 0 auto !important;',
    '}',
    '.scw-ws-v2-warn-chit-l { text-transform: lowercase !important; }',
