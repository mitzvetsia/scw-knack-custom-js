...
(function () {
  ...
  function actionsEl(tr) {
    ...
    if (pageLink && pageLink.getAttribute('href')) {
      ...
      edit.className = 'scw-sow-act scw-sow-act--edit';
      edit.setAttribute('href', pageLink.getAttribute('href'));
      edit.setAttribute('title', 'Edit SOW details');
      edit.innerHTML = iconSvg('edit') + '<span>Edit</span>';
