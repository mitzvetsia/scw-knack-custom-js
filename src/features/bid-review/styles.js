...
(function () {
  ...
  ns.injectStyles = function injectStyles() {
    ...
    var css = [
      ...
      '  opacity: 0.5; cursor: progress;',
      '}',
      /* Upload-new footer — primary subtle button anchored to the
         bottom of the SOW docs panel. Sits on its own row separated
         by a soft divider so it doesn't crowd the file links above. */
      '.scw-bid-review__docs--sow .scw-bid-review__docs-add {',
      '  display: flex;',
      '  align-items: center;',
      ...
      '  color: #295f91;',
      '  text-decoration: none;',
      '  font: 700 10.5px/1.2 system-ui, sans-serif;',
      '  letter-spacing: 0.06em;',
      '  text-transform: uppercase;',
      '}',
      '.scw-bid-review__docs--sow .scw-bid-review__docs-add:hover {',
      '  background: #eff6fb;',
      '  text-decoration: none;',
      '}',
      /* Fallback for any bid-package call site that still passes a
         plain addUrl (none today, but keep the style in case). */
      ...
      '.scw-bid-review__col-title-total--warn {',
      '  background: #fef2f2;',
      ...
      '  animation: scw-bid-review-warn-pulse 1.8s ease-in-out infinite;',
      '}',
      '.scw-bid-review__col-title-total--warn .scw-bid-review__col-title-total-label {',
      '  color: #991b1b !important;',
      '  font-weight: 700 !important;',
      '  text-transform: uppercase;',
      '  letter-spacing: .03em;',
      '}',
      '.scw-bid-review__col-title-total--warn .scw-bid-review__col-title-total-value {',
      '  color: #b91c1c !important;',
      '  font-weight: 800 !important;',
      '}',
      '@keyframes scw-bid-review-warn-pulse {',
      ...
      '  color: #fff;',
      '}',
      '.scw-bid-review__panel-title-label {',
      '  display: inline-flex; align-items: center;',
      '  padding: 3px 9px;',
      '  border-radius: 4px;',
      ...
      '  font-weight: 700;',
      '}',
      '.scw-bid-review__panel-title-product {',
      '  font-weight: 600;',
      '  color: rgba(255,255,255,0.95);',
      '}',
      '.scw-bid-review__panel-title-equip,',
      '.scw-bid-review__panel-title-install {',
      '  display: inline-flex; align-items: center;',
      '  padding: 2px 8px;',
      '  border-radius: 3px;',
      ...
      '}',
      /* SOW (worksheet) : Bid Details = 6 : 4 of the remaining space
         after the photo column (which is 0% when no viewer, ~38% when
         a photo is open). */
      ...
      '}',
      /* Photo strip removal — the panel\'s photo viewer covers this.
         Cover every plausible markup: standalone inline-photo-row
         <tr> that may have been moved alongside the wsTr, the photo
