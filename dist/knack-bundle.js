    ...
    $allGroupRows.each(function () {
      ...
      if (level === 1 || level === 2) {
        ...
        footerQueue.push({
          ...
          // ✅ PATCH (2026-02-03d):
          // Only Level-2 footers may hide Qty/Cost. Level-1 subtotal must always show.
    ...
    for (const anchorEl of anchors) {
      ...
      for (const item of items) {
        const $row = buildSubtotalRow({
          ...
          // ✅ PATCH (2026-02-03d): belt-and-suspenders
          hideQtyCost: item.level === 2 && item.hideQtyCostColumns,
        });
