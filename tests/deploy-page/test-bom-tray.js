...
window.SCW = { CONFIG: {},
  ...
  deployNav: { openPanel(o) { opened = o; document.body.appendChild(o.el); return true; } } };
...
setTimeout(() => {
  ...
  const g2 = [...tray2.querySelectorAll('.scw-bom__table')][0].querySelectorAll('.scw-bom__group td');
  check('By MDF / IDF regroups the shipping rows by location, toggle state persists', [[...g2].map(g => g.textContent), tray2.getAttribute('data-scw-bom-mode'), window.localStorage.getItem('scw:bom:mode')], [['Default MDF', 'IDF 01'], 'loc', 'loc']);
